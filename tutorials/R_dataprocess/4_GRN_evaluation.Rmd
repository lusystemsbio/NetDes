...
Once the GRNs are simulated, one can compare the network gene expression dynamics to the smoothed gene expression trajectories from the scRNA-seq data. We chose 6 points as the reference cell states and mapped the simulation data to these 6 states. The quality of the mapping will be evaluated by the following metrics:
